...
public class RegisForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("EZFOOD");

        jLabel3.setFont(new java.awt.Font("Segoe UI Light", 0, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(204, 204, 204));
        jLabel3.setText("copyright © EzFood All rights reserved");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // Membuka loginform saat tombol Login diklik
    this.setVisible(false); // Menyembunyikan form registrasi
    new loginform().setVisible(true); // Membuka form login // TODO add your handling code here:
    ...
    private void SignUpBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SignUpBtnActionPerformed
        ...
        char[] passChars = pass.getPassword(); // Mengambil karakter password sebagai array
        String pass = new String(passChars).trim(); // Mengonversi array karakter menjadi string

    if (!username.isEmpty() && !email.isEmpty() && passChars.length > 0) {
        try {
            Connection conn = dbKoneksi.getConnection();
            String query = "INSERT INTO akun (username, password, email, role ,saldo) VALUES (?, ?, ?, ?, ?)";
            PreparedStatement pst = conn.prepareStatement(query);
            pst.setString(1, username);
            pst.setString(2, pass);
            pst.setString(3, email);
            pst.setString(4, "user"); // Default permission
            pst.setInt(5, saldo);

            int rowsInserted = pst.executeUpdate();
            if (rowsInserted > 0) {
                JOptionPane.showMessageDialog(this, "Registrasi Berhasil", "Success", JOptionPane.INFORMATION_MESSAGE);
                // You can redirect to login form here if needed
            } else {
